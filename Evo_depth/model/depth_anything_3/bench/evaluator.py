...
from model.depth_anything_3.bench.print_metrics import MetricsPrinter
from model.depth_anything_3.utils.parallel_utils import parallel_execution
from model.depth_anything_3.bench.registries import MV_REGISTRY
from model.depth_anything_3.utils.constants import EVAL_REF_VIEW_STRATEGY
...
class Evaluator:
    ...
    def _compute_pose_with_gt(self, result_path: str, gt_meta: Dict) -> TDict[str, float]:
        ...
        """
        from model.depth_anything_3.bench.dataset import _wait_for_file_ready
        from model.depth_anything_3.bench.utils import compute_pose
        from model.depth_anything_3.utils.geometry import as_homogeneous
...
if __name__ == "__main__":
    ...
    from model.depth_anything_3.cfg import load_config
