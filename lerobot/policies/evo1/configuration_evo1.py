...
class Evo1Config(PreTrainedConfig):
    ...
    def __post_init__(self):
        ...
        if self.finetune_da3 is None:
            self.finetune_da3 = self.use_da3 and self.training_stage == "stage2"
        if self.finetune_da3 and not self.use_da3:
            raise ValueError("finetune_da3=True requires use_da3=True")
