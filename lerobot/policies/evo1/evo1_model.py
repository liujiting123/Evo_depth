...
class EVO1(nn.Module):
    def __init__(self, config: dict):
        ...
        self.use_da3 = bool(_cfgget(config, "use_da3", False))
        self.embedder = InternVL3Embedder(
            ...
            da3_checkpoint_dir=_cfgget(config, "da3_checkpoint_dir", None),
    ...
    def set_finetune_flags(self):
        finetune_vlm = bool(_cfgget(self.config, "finetune_vlm", False))
        finetune_language_model = bool(_cfgget(self.config, "finetune_language_model", False))
        finetune_vision_model = bool(_cfgget(self.config, "finetune_vision_model", False))
        ...
        if self.use_da3:
            finetune_da3 = bool(_cfgget(self.config, "finetune_da3", False))
            if hasattr(self.embedder, "dpt_embedder"):
                self._set_module_trainable(self.embedder.dpt_embedder, finetune_da3)
            if hasattr(self.embedder, "dpt_linear_film"):
                self._set_module_trainable(self.embedder.dpt_linear_film, True)
