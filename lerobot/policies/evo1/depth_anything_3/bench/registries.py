...
from lerobot.policies.evo1.depth_anything_3.utils.registry import Registry
...
def _import_all_datasets_once():
    """
    Scan and import all .py submodules under model.depth_anything_3.bench.datasets
    ...
    with _lock:
        ...
        pkg_name = "model.depth_anything_3.bench.datasets"
