...
from lerobot.policies.evo1.depth_anything_3.bench.registries import MV_REGISTRY, MONO_REGISTRY


def __getattr__(name):
    """Lazy import to avoid circular import when running as __main__."""
    if name == "Evaluator":
        from lerobot.policies.evo1.depth_anything_3.bench.evaluator import Evaluator
        return Evaluator
