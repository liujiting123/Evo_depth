...
from lerobot.policies.evo1.depth_anything_3.cfg import create_object
from lerobot.policies.evo1.depth_anything_3.model.utils.transform import pose_encoding_to_extri_intri
from lerobot.policies.evo1.depth_anything_3.utils.alignment import (
...
from lerobot.policies.evo1.depth_anything_3.utils.geometry import affine_inverse, as_homogeneous, map_pdf_to_opacity
from lerobot.policies.evo1.depth_anything_3.utils.ray_utils import get_extrinsic_from_camray
...
class DepthAnything3Net(nn.Module):
    ...
    def forward(
        ...
        #     print(f"layer {i}:")
        #     print("  feat shape:", a.shape)
        #     print("  tokens shape:", b.shape)
        
        # for i, cam_tok in enumerate(aux_feats):
        #     print(f"layer {i}:")
        #     print("  cam_token shape:", cam_tok.shape)
    ...
    def _get_dpt_embedding(
        ...
        assert feats[-1][0].shape[-2] == 1296, f"Please check the input image size{feats[-1][0].shape}"
        return feats[-1][0]
