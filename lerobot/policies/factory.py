...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "rlt_td3":
        return RLTTD3Config(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, RLTTD3Config):
        from lerobot.policies.rlt_td3.processor_rlt_td3 import make_rlt_td3_pre_post_processors

        processors = make_rlt_td3_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
