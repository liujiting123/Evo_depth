...
_LOGGED_VIDEO_BACKENDS: set[str] = set()
...
def decode_video_frames(
    ...
    if backend not in _LOGGED_VIDEO_BACKENDS:
        logging.info("Video decoding backend in use: %s", backend)
        _LOGGED_VIDEO_BACKENDS.add(backend)
